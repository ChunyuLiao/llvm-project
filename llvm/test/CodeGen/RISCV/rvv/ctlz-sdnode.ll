...
; CHECK-F-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; CHECK-F-NEXT:    vwsubu.wv v8, v8, v9
; CHECK-F-NEXT:    fsrm a0
; CHECK-F-NEXT:    ret
;
...
; CHECK-F-NEXT:    vmv.v.x v8, a1
; CHECK-F-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; CHECK-F-NEXT:    vwsubu.wv v8, v8, v10
; CHECK-F-NEXT:    fsrm a0
; CHECK-F-NEXT:    ret
;
...
; CHECK-F-NEXT:    vmv.v.x v8, a1
; CHECK-F-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; CHECK-F-NEXT:    vwsubu.wv v8, v8, v12
; CHECK-F-NEXT:    fsrm a0
; CHECK-F-NEXT:    ret
;
