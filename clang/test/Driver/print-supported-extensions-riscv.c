...
// CHECK-NEXT:     smlwid               1.0       'Smlwid' (Machine-mode Lower-privilege World Identifier)
// CHECK-NEXT:     smlwidlist           1.0       'Smlwidlist' (Machine-mode Lower-privilege World Identifier List)
// CHECK-NEXT:     smpmpmt              0.6       'Smpmpmt' (PMP-based Memory Types Extension)
// CHECK-NEXT:     smwid                1.0       'Smwid' (Machine-mode World Identifier)
// CHECK-NEXT:     smwiddeleg           1.0       'Smwiddeleg' (Machine-mode World Identifier Delegation)
...
// CHECK-NEXT:     sswid                1.0       'Sswid' (Supervisor-mode World Identifier)
